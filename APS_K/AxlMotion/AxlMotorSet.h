...
public:
	...
	bool HomeProcessAll_1st();			//! 전체 원점 동작.
	...
	bool Lens_LaserAlign_Motor_Move(int index, double offsetX = 0, double offsetY = 0, double offsetTh = 0);
	bool Lens_LaserAlign_Motor_MoveZ(int index, bool evasionMode = false);
	bool Lens_LaserAlign_Motor_MoveXY(int MoveType, int index, double offsetX = 0, double offsetY = 0);
	bool Lens_LaserAlign_Tilt_Move(int index, double offsetX = 0.0, double offsetY = 0.0);
	...
	bool Lens_Motor_MoveXY(int MoveType, int index, double offsetX=0.0, double offsetY=0.0, bool bWait = true);
	...
	bool INSP_Motor_MoveX(int index, double offsetX = 0.0, bool bWait = true);			//IM
